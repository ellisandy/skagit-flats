...
/// column. Characters are rendered with 1-pixel spacing (capped at 4px at
/// larger scales), giving a 9x17 cell at base scale.
...
mod tests {
    ...
    fn font_size_large_dims() {
        // Large: 8× scale, glyph 64×128, cell 68×136 (spacing capped at 4px)
        assert_eq!(FontSize::Large.glyph_w(), 64);
        assert_eq!(FontSize::Large.glyph_h(), 128);
        assert_eq!(FontSize::Large.cell_w(), 68);
