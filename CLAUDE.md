...
**YOU ARE IN: `SkagitFlats/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/SkagitFlats/` (rig root) or other directories
...
**Your mail address:** `SkagitFlats/polecats/rust`
**Your rig:** SkagitFlats
**Your Witness:** `SkagitFlats/witness`
...
| Ask Witness for help | `gt mail send SkagitFlats/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`SkagitFlats/witness`) when:
...
```bash
gt mail send SkagitFlats/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
